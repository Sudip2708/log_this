...
class CLIStyler(
    ...
    # Přidává metody: check_style_attributes(styles_dict), _get_style_attributes_set(), _raise_attributes_error(attributes_set, styles_set)

    SetCurrentStylesAttributesMixin, # Metoda pro změnu/nastavení atributů pro styly
    # Přidává metody: set_current_styles_attributes(), _get_current_styles_dict(), _set_style_attributes(styles_dict)
    ...
    # Používá metody: set_current_styles_attributes()
    # Používá atributy: _colors_modes, _current_colors_mode

    SetSignSetMixin,  # Metoda pro změnu sady znaků
    # Přidává metody: set_sign_set(signs_set), _validate_signs_set(signs_set)
    # Používá metody: set_current_styles_attributes()
