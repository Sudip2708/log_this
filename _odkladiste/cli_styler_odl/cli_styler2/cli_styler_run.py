from ._signs.cli_sings import CLISigns
from ._colors.cli_colors import CLIColors
...
class CLIStylerRun(metaclass=AbcSingletonMeta):
    ...
    def _initialize(self):
        ...
        self.cli_styler = CLIStyler(self.cli_signs, self.cli_colors)
    ...
    def _apply_changes(self):
        ...
        self.cli_styler.set_styler_attributes(self.cli_signs, self.cli_colors)
