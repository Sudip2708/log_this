...
def get_validate_class(annotation) -> 'Optional[Callable]':
    """Vrací validační třídu podle anotace (nejprve přes `origin`, pak podle klíče)."""
    return (get_origin_validate_class(annotation)
            or get_key_validate_class(annotation))
