...
def validate_native_type(
    ...
    try:
        ...
        if not isinstance(value, expected_type):
            ...
            # Ověření zda se ověřovala jedna hodnota nebo tuple
            ...
            raise ValidatorTypeError(
                f"\n"
                f"Zachycena hodnota, neodpovídající požadovanému typu.\n"
                f"- Typ hodnoty {value} ('{type(value).__name__}') neodpovídá požadovanému typu: '{expected_type.__name__}'.\n"
