...
def verify_dict(value, key_type, value_type, deep_check):
    """Ověří klíče a hodnoty ve slovníku podle očekávaných typů."""
    return all(
        verify(i_key, key_type, deep_check)
        and verify(i_value, value_type, deep_check)
