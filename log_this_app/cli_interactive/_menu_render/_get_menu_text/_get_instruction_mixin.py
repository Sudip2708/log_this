...
class GetInstructionMixin(ABC):
    ...
    def _get_instruction(self):
        ...
        menu_name = self.mm.current_menu.menu_name.lower()
        menu_help = self.mm.current_menu.menu_help
        last_item_id = len(menu_help) - 1
        ...
        return [
            ...
            # Nadpis nápovědy
            style.title(f"Popis položek pro {menu_name}:"),
