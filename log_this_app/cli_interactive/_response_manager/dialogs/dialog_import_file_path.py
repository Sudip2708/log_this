...
def dialog_import_file_path(menus_manager):
    """
    ...
    try:
        # Intro text
        cli_print.info.title("Výběr cesty k souboru s konfigurací")
        ...
        selected_path = filedialog.askopenfilename(title="Vyberte soubor")
