...
class BaseTypeValidator:
    ...
    def __init_subclass__(cls):
        """Metoda pro kontrolu poviných atributů"""
        super().__init_subclass__(**kwargs)
        # Atributy, jejichž existence má být ověřena
        required_attrs = ("VALIDATOR_KEY", "ORIGIN")
        # Zjisti, které atributy nejsou vůbec definovány
    ...
    def __call__(self, value, annotation, inner_check, custom_types, bool_only):
        return self.validate(value, annotation, inner_check, custom_types, bool_only)
    ...
    def validate(self, value, annotation, inner_check, custom_types, bool_only):
        return self.validate_native_type(value, self.ORIGIN)
