...
from ...._validators import dictionary_validator_for_nametuple
...
class NamedTupleValidator(DictionaryValidatorBase):
    ...
    ORIGIN = namedtuple  # Nedá se použít na ověření typu - jedná se o funkci pro vytváření jednoduchých tříd podobných strukturám nebo záznamům - ověření typu je prováděno dle vlastní funkce _is_named_tuple()
