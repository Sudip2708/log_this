...
from .has_attr_verifier import has_attr_verifier
from .has_attrs_verifier import has_attrs_verifier


def has_attribute_verifier(
    obj: Any,
    ...
    if isinstance(attribute, str):
        return has_attr_verifier(obj, attribute, bool_only)

    # Vyřízení pro více položek
    if isinstance(attribute, IterableOrigin):
        return has_attrs_verifier(obj, attribute, bool_only)
