...
from .has_callable_attrs_verifier import has_callable_attrs_verifier


def has_callable_attribute_verifier(
    obj: Any,
    ...
    if isinstance(attribute, str):
        return has_callable_attr_verifier(obj, attribute, bool_only)

    # Vyřízení pro více položek
    if isinstance(attribute, IterableOrigin):
        return has_callable_attrs_verifier(obj, attribute, bool_only)
