...
class VerifyAttributeParameterError(VerifyParameterError, TypeError):
    ...
    def __init__(self, attribute_name: Any):
        ...
        what_happened = [
            ...
            "   - Název atributu může být předán funkci pouze jako řetězec (str) nebo iterovatelný objekt s řetězci.\n",
            f"   - Zadaný parametr pro jméno atributu: {repr(self.attribute)}\n",
        ...
        what_to_do = [
            ...
            "   - Ujisti se, že je předán jako řetězec nebo iterovatelný objelt s řetězci.\n",
        ]
