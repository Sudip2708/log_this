...
class OptionalValidator(BaseCustomLogicValidator):
    """
    ...
    LONG_DESCRIPTION = (
            "Validuje, že typ je Optional[T], tedy že hodnota může být typu T nebo None. "
            "Používá se pro označení nepovinných hodnot."
        )
