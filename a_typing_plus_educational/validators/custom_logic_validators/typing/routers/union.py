...
from ....._bases import BaseCustomLogicValidator, T1, T2
from ....._verifiers import inner_args_transmitter


class UnionValidator(BaseCustomLogicValidator):
    """
    ...
    LONG_DESCRIPTION = (
            "Validuje, že typ je Union, což znamená, že hodnota může být "
            "jedním z více uvedených typů (např. Union[int, str])."
        )
