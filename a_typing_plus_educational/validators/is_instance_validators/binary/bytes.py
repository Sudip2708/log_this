...
class BytesValidator(BaseIsInstanceValidator):
    """
    ...
    IS_INSTANCE = bytes
    HAS_ATTRS = "__getitem__", "__setitem__", "__len__", "decode"
    CALLABLE_ATTRS = None

    DESCRIPTION = "Neměnné pole bajtů"
    LONG_DESCRIPTION = (
            "Validuje, že objekt je typu bytes, tedy neměnná sekvence bajtů "
            "(celých čísel 0-255). Používá se pro binární data a operace."
        )
