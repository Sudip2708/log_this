...
class AwaitableValidator(BaseIsInstanceValidator):
    """
    ...
    LONG_DESCRIPTION = (
            "Validuje, že objekt splňuje rozhraní Awaitable z collections.abc, "
            "tedy že implementuje metodu __await__ a může být použit "
            "s klíčovým slovem 'await' v asynchronních funkcích."
        )
