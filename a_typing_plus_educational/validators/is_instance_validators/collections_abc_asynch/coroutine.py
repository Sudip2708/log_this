...
class CoroutineValidator(BaseIsInstanceValidator):
    """
    ...
    LONG_DESCRIPTION = (
            "Validuje, že objekt splňuje rozhraní Coroutine z collections.abc, "
            "tj. objekt vytvořený pomocí async def nebo asyncio.coroutine. "
            "Podporuje metody send, throw a close, a má __await__."
        )
