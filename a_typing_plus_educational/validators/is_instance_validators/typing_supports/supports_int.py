...
class SupportsIntValidator(BaseIsInstanceValidator):
    """
    ...
    LONG_DESCRIPTION = (
            "Validuje, že objekt splňuje protokol SupportsInt, "
            "tedy implementuje metodu __int__, která umožňuje konverzi objektu "
            "na celé číslo pomocí funkce int()."
        )
