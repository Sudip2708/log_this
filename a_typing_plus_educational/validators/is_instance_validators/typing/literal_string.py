...
class LiteralStringValidator(BaseIsInstanceValidator):
    ...
    LONG_DESCRIPTION = (
            "Validuje, že typ je LiteralString, což označuje řetězec, "
            "který je literálem nebo je složen z literálů. "
            "Používá se k prevenci SQL injection a podobných útoků."
        )
