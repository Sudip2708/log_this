...
class HashableValidator(BaseIsInstanceValidator):
    """
    ...
    LONG_DESCRIPTION = (
            "Validuje, že objekt splňuje rozhraní Hashable z collections.abc, "
            "tedy že implementuje metodu __hash__ a může být použit "
            "jako klíč ve slovníku nebo prvek množiny."
        )
